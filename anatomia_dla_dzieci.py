...
def _res(relative_path):
    # działa zarówno z .py jak i z .exe (PyInstaller --onefile)
...
boy_front_picture = QPixmap(_res("obrazki/jpg2png/boy_front.png")).scaledToHeight(700,mode=Qt.SmoothTransformation)
boy_front_picture_item = scene_boy_front.addPixmap(boy_front_picture)
girl_front_picture = QPixmap(_res("obrazki/jpg2png/girl_front.png")).scaledToHeight(700,mode=Qt.SmoothTransformation)
girl_front_picture_item = scene_girl_front.addPixmap(girl_front_picture)

boy_back_picture = QPixmap(_res("obrazki/jpg2png/boy_back.png")).scaledToHeight(700,mode=Qt.SmoothTransformation)
boy_back_picture_item = scene_boy_back.addPixmap(boy_back_picture)
girl_back_picture = QPixmap(_res("obrazki/jpg2png/girl_back.png")).scaledToHeight(700,mode=Qt.SmoothTransformation)
girl_back_picture_item = scene_girl_back.addPixmap(girl_back_picture)

boy_head_picture = QPixmap(_res("obrazki/jpg2png/boy_head.png")).scaledToWidth(700,mode=Qt.SmoothTransformation)
boy_head_picture_item = scene_boy_head.addPixmap(boy_head_picture)
boy_head_picture_item.moveBy(-80,0)
girl_head_picture = QPixmap(_res("obrazki/jpg2png/girl_head.png")).scaledToWidth(700,mode=Qt.SmoothTransformation)
...
shoulder_sound = pygame.mixer.Sound(_res("dzwieki/bark.wav"))
hip_sound = pygame.mixer.Sound(_res("dzwieki/biodro.wav"))
eyebrow_sound = pygame.mixer.Sound(_res("dzwieki/brew.wav"))
chin_sound = pygame.mixer.Sound(_res("dzwieki/broda.wav"))
belly_sound = pygame.mixer.Sound(_res("dzwieki/brzuch.wav"))
forehead_sound = pygame.mixer.Sound(_res("dzwieki/czolo.wav"))
cleavage_sound = pygame.mixer.Sound(_res("dzwieki/dekolt.wav"))
palm_sound = pygame.mixer.Sound(_res("dzwieki/dlon.wav"))
head_sound = pygame.mixer.Sound(_res("dzwieki/glowa.wav"))
tongue_sound = pygame.mixer.Sound(_res("dzwieki/jezyk.wav"))
nape_sound = pygame.mixer.Sound(_res("dzwieki/kark.wav"))
chest_sound = pygame.mixer.Sound(_res("dzwieki/klatka_piersiowa.wav"))
knee_sound = pygame.mixer.Sound(_res("dzwieki/kolano.wav"))
ankle_sound = pygame.mixer.Sound(_res("dzwieki/kostka.wav"))
elbow_sound = pygame.mixer.Sound(_res("dzwieki/lokiec.wav"))
calf_sound = pygame.mixer.Sound(_res("dzwieki/lydka.wav"))
scrotum_sound = pygame.mixer.Sound(_res("dzwieki/moszna.wav"))
wrist_sound = pygame.mixer.Sound(_res("dzwieki/nadgarstek.wav"))
nose_sound = pygame.mixer.Sound(_res("dzwieki/nos.wav"))
eye_sound = pygame.mixer.Sound(_res("dzwieki/oko.wav"))
groin_sound = pygame.mixer.Sound(_res("dzwieki/pachwina.wav"))
finger_sound = pygame.mixer.Sound(_res("dzwieki/palec.wav"))
penis_sound = pygame.mixer.Sound(_res("dzwieki/penis.wav"))
belly_button_sound = pygame.mixer.Sound(_res("dzwieki/pepek.wav"))
heel_sound = pygame.mixer.Sound(_res("dzwieki/pieta.wav"))
back_sound = pygame.mixer.Sound(_res("dzwieki/plecy.wav"))
cheek_sound = pygame.mixer.Sound(_res("dzwieki/policzek.wav"))
buttock_sound = pygame.mixer.Sound(_res("dzwieki/posladek.wav"))
eyelid_sound = pygame.mixer.Sound(_res("dzwieki/powieka.wav"))
forearm_sound = pygame.mixer.Sound(_res("dzwieki/przedramie.wav"))
arm_sound = pygame.mixer.Sound(_res("dzwieki/ramie.wav"))
hand_sound = pygame.mixer.Sound(_res("dzwieki/reka.wav"))
lashes_sound = pygame.mixer.Sound(_res("dzwieki/rzesy.wav"))
temple_sound = pygame.mixer.Sound(_res("dzwieki/skron.wav"))
vulva_sound = pygame.mixer.Sound(_res("dzwieki/srom.wav"))
foot_sound = pygame.mixer.Sound(_res("dzwieki/stopa.wav"))
neck_sound = pygame.mixer.Sound(_res("dzwieki/szyja.wav"))
torso_sound = pygame.mixer.Sound(_res("dzwieki/tulow.wav"))
ear_sound = pygame.mixer.Sound(_res("dzwieki/ucho.wav"))
thigh_sound = pygame.mixer.Sound(_res("dzwieki/udo.wav"))
lips_sound = pygame.mixer.Sound(_res("dzwieki/usta.wav"))
hair_sound = pygame.mixer.Sound(_res("dzwieki/wlosy.wav"))
teeth_sound = pygame.mixer.Sound(_res("dzwieki/zeby.wav"))
